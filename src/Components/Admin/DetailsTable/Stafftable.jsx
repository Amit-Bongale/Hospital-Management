...
function Stafftable() {
  ...
  return (
    <div className="w-full">
      ...
      {deleteitem ? (
        <DeleteStaff setisopen={setdelete} staffid={staffid} />
      ) : (
        <></>
      )}
          ...
          {staffinfo.map((staff) => (
            <tbody>
              <tr class="bg-white border-b font-medium text-gray-700  dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4">
                  {
                    staff.status ?  <span className="bg-green-700 py-2 px-6 text-white rounded-2xl"> Active </span> : <span className="bg-red-700 py-2 px-6 text-white rounded-2xl"> Inactive </span>
                  }
                </td>
